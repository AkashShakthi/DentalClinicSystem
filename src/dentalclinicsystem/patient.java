...
ResultSet Rs = null, Rs1 = null;
 ...
 boolean Patname;
    ...
    private void PatientTableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_PatientTableMouseClicked
        ...
        PatAllergies.setText(model.getValueAt(MyIndex, 5).toString());
        PatAddress.setText(model.getValueAt(MyIndex, 6).toString());
        //PatDOB.setText(model.getValueAt(MyIndex, 7).toString());ccccccccccccccccccccccccccccccccccccccccccccccccccccc
